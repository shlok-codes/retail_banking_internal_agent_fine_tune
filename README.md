...
```
data/
    retail_banking_internal_agent_1000_for_gpt-4o-mini.jsonl

demo questions/
    finetune_demo_questions_200.csv
...
videos/
    deploying_fine-tuned_model.mp4
    testing_fine-tuned_model.mp4
...
- **Project Name:** `retail_banking_internal_agent_fine_tune`  
...
Metrics are summarized in `logs/training_metrics.json`.
...
These curves indicate **smooth, stable learning** with no major overfitting signals.
...
**Prompt:**  
*How do we annotate CRM when a customer reports possible Zelle fraud?*
...
**Prompt:**  
*Explain Reg CC funds availability for a check over $5,525 deposited at a branch.*
...
**Prompt:**  
*A customer is locked out after 3 failed mobile login attempts. What is the internal troubleshooting flow?*
...
2. Prepare a JSONL dataset of internal-style Q&A examples. Or use the jsonl file from the data folder in this repo. 
...
7. Test in Azure (Playground or REST API). If you used the jsonl file from this repo, refer to the demo questions in the repo to test the model.
